...
def main():
    ...
    if short_code == 'cn':
        ...
        print('*' * 100)
        print(f'Hello {username}, Account created successfully! Your password is: {password}')
        print('*' * 100)
    ...
    while True:
        ...
        if short_code == "cnc":
            ...
            print('\n')
            print(f'Account Credential for: {account} - userName: {user_name} - password: {password} created successfully')
            print('\n')
        elif short_code == 'd':
            ...
            if find_credential(search_name):
                ...
                print('\n')
                print(f'Saved credentials for: {search_credential.account} successfully deleted')
                print('\n')
            else:
                print('Credential does not exist')
